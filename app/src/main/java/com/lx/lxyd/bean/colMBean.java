...
/**
 * Description:
 * Data：2019/12/14-23:08
 * Author: fushuaige
 */
public class colMBean  implements Parcelable {
    ...
    public static final Creator<colMBean> CREATOR = new Creator<colMBean>() {
        @Override
        public colMBean createFromParcel(Parcel source) {
            return new colMBean(source);
        }

        @Override
        public colMBean[] newArray(int size) {
            return new colMBean[size];
        }
    };
}
