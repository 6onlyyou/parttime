 ...
 * Author: fushuaige
 */
public class hisMBean implements Parcelable {
    ...
    public static final Creator<hisMBean> CREATOR = new Creator<hisMBean>() {
        @Override
        public hisMBean createFromParcel(Parcel source) {
            return new hisMBean(source);
        }

        @Override
        public hisMBean[] newArray(int size) {
            return new hisMBean[size];
        }
    };
}
