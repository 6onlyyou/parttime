...
public class GlideUtil {
    ...
    public static void loadPlaceHolder(Context mContext, String path, ImageView mImageView) {
        if (TextUtils.isEmpty(path)) {
            loadDefault(mContext, path, mImageView);
            return;
        }
        Glide.with(mContext).load(path)
                .transform(new MyRoundCornersTransformation(mContext, com.lx.lxyd.utils.Util.dip2px(mContext, 36),
